			    ...
			    <div className="row">
			      <div className="col-lg-12">
			        <div className="section-title-area ltn__section-title-2--- text-center---">
			          <h6 className="section-subtitle section-subtitle-2--- ltn__secondary-color">Under Construction Properties</h6>
			      ...
			      <div className="col-lg-3"  >
			        <div className="ltn__search-by-place-item">
			          <div className="search-by-place-img">
			            <Link to="/uccentral"><img src={publicUrl+"assets/img/Centralnoida.png"} alt="#" /></Link>
			          ...
			          <div className="search-by-place-info">
			            <h6><Link to="/uccentral">15 MIN From DND</Link></h6>
			            <h4><Link to="/uccentral">Central Noida</Link></h4>
			            <div className="search-by-place-btn">
						<Link to="/uccentral">View Properties <i className="flaticon-right-arrow" /></Link>
			            </div>
			          </div>
			        </div>
			      </div>
