...
import Dialog from '../../Pageview/Dialog';
			      ...
			      <div className="row">
			        <div className="col-md-7">
			          <div className="ltn__top-bar-menu">
			            <ul>
			              <li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" />info@luxuryapartment.co.in</a></li>
			              <li><a href="locations.html"><i class="fa-solid fa-phone-volume" /> +91-9313-388-388</a></li>
			            </ul>
			          </div>
			        </div>
			        ...
			        <div className="col">
			          <div className="site-logo-wrap">
			            <div className="site-logo go-top">
			              <Link to="/"><img src={publicUrl+"assets/img/Logonew.png"} alt="Logo" style={{width:"100px"}}/></Link>
			            </div>
			            ...
			            <nav>
			              <div className="ltn__main-menu">
			                <ul>
			                  ...
			                  <li ><Link to="/shop">Projects <i class="fa fa-angle-down" aria-hidden="true"></i></Link>
			               <ul>
									<li><Link to="/all">All Projects</Link></li>
									<li><Link to="/rtm">Ready To Move</Link></li>
									<li><Link to="/uc">Under Construction</Link></li>
									
			                    </ul> 
			                  </li>
							  <li ><Link to="/blog-grid">Video Gallery</Link>
			                    {/* <ul>
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					...
					<div className="site-logo">
						<Link to="/"><img src={publicUrl+"assets/img/logo.png"} alt="Logo" style={{width:"50%"}}/></Link>
					</div>
