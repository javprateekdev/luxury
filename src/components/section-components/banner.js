				            ...
				            <div className="col-lg-12 align-self-center">
				              <div className="slide-item-info">
				                <div className="slide-item-info-inner ltn__slide-animation">
				                  ...
				                  <h6 className="slide-sub-title white-color--- animated"><span><i className="fas fa-home" /></span> Premuim Residences</h6>
				                  <h1 className="slide-title animated ">Experience Unsurpassed Opulence<br /> in Your Next Home</h1>
