			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            <Link to="/product-details"><img src={data.img} alt="#" /></Link>
			            ...
			            <div className="product-img-location-gallery">
			              <div className="product-img-location">
			                <ul>
			                  <li>
			                    <Link to="/contact"><i className="flaticon-pin" /> {data.address1}</Link>
			                  </li>
			                </ul>
			              </div>
			          ...
			          <div className="product-info">
			            ...
			            <h2 className="product-title go-top"><Link to="/product-details">{data.propertyname}</Link></h2>
			          ...
			          <div >
						...
						<Link to={`detailview/${data.id}`} className="theme-btn-1 btn btn-effect-1" style={{margin:"10px"}}>View Project Details</Link>
			                  </div>
			            </div>
			          </div>
			        </div>
