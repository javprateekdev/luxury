			    ...
			    <div className="row">
			      <div className="col-lg-12">
			        <div className="section-title-area ltn__section-title-2--- text-center---">
			          <h6 className="section-subtitle section-subtitle-2--- ltn__secondary-color--- white-color">Trending Projects</h6>
			          <h1 className="section-title  white-color">Experience the Ultimate in Modern Living</h1>
			        </div>
			      </div>
			    </div>
