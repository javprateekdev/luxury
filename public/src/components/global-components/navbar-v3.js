			        ...
			        <div className="col">
			          <div className="site-logo-wrap">
			            <div className="site-logo go-top">
			              <Link to="/"><img src={publicUrl+"assets/img/Logonew.png"} alt="Logo" style={{width:"130px"}}/></Link>
			            </div>
			            ...
			            <nav>
			              <div className="ltn__main-menu">
			                <ul>
			                  ...
			                  <li className=""><Link to="/shop">Projects</Link>
			                    {/* <ul>
							  ...
							  <li className="menu-icon"><Link to="/blog-grid">Video Gallery</Link>
			                    {/* <ul>
			                ...
			                <a><Dialog/></a> 
							  ...
							  <li className="special-link">
			                    <Link to="/">Compare Properties</Link>
			                  </li>
			                </ul>
			              </div>
			            </nav>
